...
class connect_friends_signedin(unittest.TestCase):
          
    def friends_signedin_test(self, webd_wrap):
    ...
    def test_friends_signedin(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.friends_signedin_test(webdriver_wrapper(browser))
