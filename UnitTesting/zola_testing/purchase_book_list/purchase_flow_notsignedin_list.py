...
class test_purchase_notsignedin(unittest.TestCase):
    ...
    def purchase_notsignedin_list_test(self, webd_wrap):
    ...
    def test_purchase_notsignedin_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_notsignedin_list_test(webdriver_wrapper(browser))
