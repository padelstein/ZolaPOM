...
class test_purchase_signup(unittest.TestCase):
    ...
    def purchase_signup_list_test(self, webd_wrap):
    ...
    def test_purchase_signup_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_signup_list_test(webdriver_wrapper(browser))
