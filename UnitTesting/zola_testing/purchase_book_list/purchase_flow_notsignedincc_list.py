...
class test_purchase_notsignedincc(unittest.TestCase):
    ...
    def purchase_notsignedincc_list_test(self, webd_wrap):
    ...
    def test_purchase_notsignedincc_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_notsignedincc_list_test(webdriver_wrapper(browser))
