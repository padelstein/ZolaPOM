...
class test_purchase_signedincc(unittest.TestCase):
    ...
    def purchase_signedincc_profile_test(self, webd_wrap):
    ...
    def test_purchase_signedincc_profile(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_signedincc_profile_test(webdriver_wrapper(browser))
