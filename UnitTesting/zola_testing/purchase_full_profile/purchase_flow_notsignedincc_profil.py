...
class test_purchase_notsignedincc(unittest.TestCase):
    ...
    def purchase_notsignedincc_profile_test(self, webd_wrap):
    ...
    def test_purchase_notsignedincc_profile(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_notsignedincc_profile_test(webdriver_wrapper(browser))
