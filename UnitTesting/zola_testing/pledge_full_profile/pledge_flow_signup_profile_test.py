...
class test_pledge_flow_signup_profile(unittest.TestCase):
          
    def pledge_flow_signup_profile_test(self, webd_wrap):
        ...
        page_bookseller_profile.sign_in_modal.click_sign_up()
    ...
    def test_pledge_signup_profile(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.pledge_flow_signup_profile_test(webdriver_wrapper(browser))
