...
class view_all(unittest.TestCase):
          
    def view_all_test(self, webd_wrap):
        ...
        page_your_collection.click_all_rated()
        
        webd_wrap.check_url('https://zolaqc.com/collection/list/all_rated/')
        
        page_your_collection.click_view_all()
    ...
    def test_view_all(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.view_all_test(webdriver_wrapper(browser))
