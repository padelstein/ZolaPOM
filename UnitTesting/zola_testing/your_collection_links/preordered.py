...
class preordered(unittest.TestCase):
          
    def preordered_test(self, webd_wrap):
        ...
        page_your_collection.click_preordered()
    ...
    def test_preordered(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.preordered_test(webdriver_wrapper(browser))
