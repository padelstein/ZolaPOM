...
class all_rated(unittest.TestCase):
          
    def all_rated_test(self, webd_wrap):
    ...
    def test_all_rated(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.all_rated_test(webdriver_wrapper(browser))
