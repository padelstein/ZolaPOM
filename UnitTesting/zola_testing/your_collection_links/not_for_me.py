...
class not_for_me(unittest.TestCase):
          
    def not_for_me_test(self, webd_wrap):
        ...
        page_your_collection.click_not_for_me()
        
        webd_wrap.check_url('https://zolaqc.com/collection/list/not_for_me/')
        webd_wrap.close_the_browser()
        
        
    
    def test_not_for_me(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.not_for_me_test(webdriver_wrapper(browser))
