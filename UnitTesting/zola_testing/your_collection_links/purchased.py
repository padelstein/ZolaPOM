...
class purchased(unittest.TestCase):
          
    def purchased_test(self, webd_wrap):
        ...
        page_your_collection.click_purchased()
    ...
    def test_purchased(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchased_test(webdriver_wrapper(browser))
