...
class wishlist_signedin(unittest.TestCase):
          
    def wishlist_signedin_test(self, webd_wrap):
    ...
    def test_wishlist_signedin(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.wishlist_signedin_test(webdriver_wrapper(browser))
