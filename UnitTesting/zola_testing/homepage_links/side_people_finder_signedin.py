...
class side_people_finder_signedin(unittest.TestCase):
          
    def people_finder_signedin_test(self, webd_wrap):
    ...
    def test_people_finder_signedin(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.people_finder_signedin_test(webdriver_wrapper(browser))
