...
class zola_network_signup(unittest.TestCase):
          
    def zola_network_signup_test(self, webd_wrap):
    ...
    def test_zola_network_signup(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.zola_network_signup_test(webdriver_wrapper(browser))
