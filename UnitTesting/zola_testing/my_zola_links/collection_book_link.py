...
class my_zola_collection_book_link(unittest.TestCase):
          
    def collection_book_link_test(self, webd_wrap):
        ...
        page_my_zola.click_collection_book_link()
    ...
    def test_collection_book_link(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.collection_book_link_test(webdriver_wrapper(browser))
