...
class follow_flow_signup_test(unittest.TestCase):
    ...
    def follow_signup_modal_test(self, webd_wrap):
        ...
        page_acp_list.sign_in_modal.click_sign_up()  
    ...
    def test_follow_signup_modal(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.follow_signup_modal_test(webdriver_wrapper(browser))
