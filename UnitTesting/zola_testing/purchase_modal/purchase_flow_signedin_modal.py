...
class test_purchase_signedin(unittest.TestCase):
    ...
    def purchase_signedin_modal_test(self, webd_wrap):
    ...
    def test_purchase_signedin_modal(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.purchase_signedin_modal_test(webdriver_wrapper(browser))
