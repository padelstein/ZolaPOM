...
class follow_flow_signup_test(unittest.TestCase):
    ...
    def follow_signup_list_test(self, webd_wrap):
    ...
    def test_follow_signup_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.follow_signup_list_test(webdriver_wrapper(browser))
