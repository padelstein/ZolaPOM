...
class homepage_bio(unittest.TestCase):
          
    def homepage_bio_test(self, webd_wrap):
        
        page_homepage = homepage(webd_wrap)
        page_homepage.get_page()
        page_homepage.click_category("Biography & Memoir")
    ...
    def test_homepage_bio(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.homepage_bio_test(webdriver_wrapper(browser))
