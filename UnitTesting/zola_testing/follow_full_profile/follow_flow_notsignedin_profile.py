...
from page_objects.acp_profile import acp_profile


class follow_flow_notsignedin_test(unittest.TestCase):
          
    def follow_notsignedin_profile_test(self, webd_wrap):
        ...
        page_acp_profile.sign_in_modal.sign_in(email, 'password')
    ...
    def test_follow_notsignedin_profile(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.follow_notsignedin_profile_test(webdriver_wrapper(browser))
