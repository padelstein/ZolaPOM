...
class follow_flow_signedin_test(unittest.TestCase):
    ...
    def follow_signedin_profile_test(self, webd_wrap):
    ...
    def test_follow_signedin_profile(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.follow_signedin_profile_test(webdriver_wrapper(browser))
