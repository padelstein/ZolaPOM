...
class test_rating_signedin(unittest.TestCase):
    ...
    def rating_signedin_list_test(self, webd_wrap):
    ...
    def test_rating_signedin_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.rating_signedin_list_test(webdriver_wrapper(browser))
