...
class test_rating_signup(unittest.TestCase):
    ...
    def rating_signup_list_test(self, webd_wrap):
    ...
    def test_rating_signup_list(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.rating_signup_list_test(webdriver_wrapper(browser))
