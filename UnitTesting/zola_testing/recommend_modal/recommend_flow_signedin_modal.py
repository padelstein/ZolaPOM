...
class test_recommend_flow_signedin_modal(unittest.TestCase):
          
    def recommend_flow_signedin_modal_test(self, webd_wrap):
    ...
    def test_recommend_flow_signedin_modal(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.recommend_flow_signedin_modal_test(webdriver_wrapper(browser))
