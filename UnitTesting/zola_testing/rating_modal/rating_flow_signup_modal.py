...
class test_rating_signup(unittest.TestCase):
    ...
    def test_rating_signup_modal(self): #running x as a unit test
        for browser in webdriver_wrapper._browsers:
            self.rating_signup_modal_test(webdriver_wrapper(browser))
